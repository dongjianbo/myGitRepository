...
<body>
	<div class="row">
		...
		<div class="col-md-4">
			<div class="panel panel-default">
			  <div class="panel-heading" id="ptitle">添加新课程</div>
				  <div class="panel-body">
					<form method="post">
						<div class="form-group">
							<label for="exampleInputPassword1">请输入课程名称:</label> <input
    ...
    <script type="text/javascript">
    	...
    	function loadBanJi(){
    		...
    		//获取所有的课程信息
    		$.getJSON("${pageContext.request.contextPath}/teacher/GetCourseListServlet","rand="+Math.random(),function(s){
    	...
    	function deleteBanJi(bjid){
    		var param={"bjid":bjid};
    		$.post("${pageContext.request.contextPath}/teacher/DeleteCourseServlet",param,function(r){
    			if(r=="1"){
    			...
    			if(r=="0"){
    				$("#delmessage").html("该课程下已添加考试成绩,不可删除!");
    				$("#messageDiv").modal("show");
    	...
    	function updateBanJi(){
    		...
    		$.post("${pageContext.request.contextPath}/teacher/UpdateCourseServlet",ser,function(x){
    			if(x==1){
    				toAddBJ();
    				loadBanJi();
    			}
    	...
    	function insertBanJi(){
    		...
    		//表单的值
    		var ser=$("form").serialize();
    		$.post("${pageContext.request.contextPath}/teacher/InsertCourseServlet",ser,function(x){
    			if(x==1){
