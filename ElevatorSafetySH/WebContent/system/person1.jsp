...
<script type="text/javascript">
	function toManage(v,s){
		if(v==1){
			$('#_sFrame').attr("src","${path}/servicer/list1.do");
		}
		if(v==2){
			$('#_sFrame').attr("src","${path}/safer/list1.do");
		}
		if(v==3){
			$('#_sFrame').attr("src","${path}/tester/list1.do");
		}
		if(v==4){
			$('#_sFrame').attr("src","${path}/operator/list1.do");
...
<!-- 			<li><span class="title" onclick="toManage(4,this)">监管部门人员维护</span> -->
	...
	<iframe id="_sFrame" width="100%" height="100%" frameborder="0" scrolling="no"
		...
		src="${path}/servicer/list1.do"></iframe>
